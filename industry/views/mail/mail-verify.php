                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="mcnTextContent"
                                                                                        ...
                                                                                        <span
                                                                                            ...
                                                                                            Director,</span><br>
                                                                                        <br>You have been requested for 
                                                                                        karnataka labour welfare
                                                                                        scholarship portal email change.<br>
                                                                                        <br>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="mcnButtonContent"
                                                                                        ...
                                                                                        <a class="mcnButton "
                                                                                            ...
                                                                                            href="<?php echo base_url('account/mail_verify?rid='.$id .'&client='.$email.'') ?>" target="_blank"
                                                                                            style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">verify
                                                                                            my email</a>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
