...
<body>
                        ...
                        <div class="card darken-1 ">
                            <div class="card-content bord-right ">
                                <div class="title-list ">
                                    <span class="list-title ">Scholarship Rejected List (<?php echo (!empty($result))?count($result):'0'; ?>)</span>
    ...
    <script>
        ...
        var app = new Vue({
            ...
            methods:{
                yearChange(){
                    window.location.href = "<?php echo base_url('application-rejected?year=') ?>"+this.year;
                },
            },
        })
