                                    ...
                                    <div class="card-title">
                                        ...
                                        echo '<div id="modal" class="modal">
                                            <div class="modal-content">
                                                <h4 class="center-align"><span class="material-icons warn"> warning </span></h4>
                                                <a href="#!" class="modal-close">
                    <i class="material-icons cc-close">close</i>
                </a>
                                                <h6 class="center-align white-text">Access Restricted</h6>
                                                <p class="center-align white-text" style="padding:20px">Please pay the Welfare Contribution Amount of '.$result->application_year.' to proceed further or get access to  Approve</p>
                                            </div>
                                            <div class="modal-footer center">
                                            <center> 
                                                <a href="'.$this->config->item('web_url').'contribution" target="_blank" class="center btn-small paynows waves-effect waves-light">Pay Now</a>
                                            </center>
                                            </div>
                                        </div>';
                                        
                                        
                                        echo '<a class="right blink_me mr10">Please pay the Welfare Contribution Amount of '.$result->application_year.' to proceed further or get access to  Approve</a>';
                                        } ?>
                                    </div>
