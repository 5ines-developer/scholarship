                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="mcnTextContent" style="padding: 0px 18px 9px; text-align: center;" valign="top">
                                                                                        <span style="font-size:18px">Scholarship Due Reminder</span>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0" width="640"
                                                ...
                                                <tr>
                                                    <td valign="top" class="headerContainer"
                                                        style="padding-top:9px; padding-bottom:9px;">
                                                        <table class="mcnImageBlock" style="min-width:100%;"
                                                            width="100%" cellspacing="0" cellpadding="0" border="0">
                                                            <tbody class="mcnImageBlockOuter">
                                                                <tr>
                                                                    <td style="padding:9px" class="mcnImageBlockInner"
                                                                        valign="top">
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="mcnTextContent"
                                                                                        ...
                                                                                        <br>
                                                                                        <span
                                                                                            style="font-size:22px">Dear Director,</span><br>
                                                                                        <br>This is due reminder email for industry payment contribution for karnataka labour welfare board scholarship<br>Your contribution due from last jan 15th Please Pay the contribution to avoid extra charges.
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0" width="640"
                                                ...
                                                <tr>
                                                    <td valign="top" class="footerContainer"
                                                        style="padding-top:9px; padding-bottom:9px;">
                                                        <table class="mcnDividerBlock" style="min-width:100%;"
                                                            width="100%" cellspacing="0" cellpadding="0" border="0">
                                                            <tbody class="mcnDividerBlockOuter">
                                                                <tr>
                                                                    <td class="mcnDividerBlockInner"
                                                                        style="min-width: 100%; padding: 18px 18px 36px;">
                                                                        <table class="mcnDividerContent"
                                                                            style="min-width: 100%;border-top: 1px solid #DDDDDD;"
