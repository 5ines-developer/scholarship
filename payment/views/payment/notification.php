                        ...
                        <div class="card darken-1 ">
                            <div class="card-content bord-right ">
                                <div class="title-list pb0">
                                    <span class="list-title ">Payment Reminder Notification</span>
                                </div>
                                    ...
                                    <div class="hr-list">
                                        <table id="dynamic" class="striped ">
                                            <thead class="thead-list">
                                                ...
                                                <th id="c" class="h5-para-p2">Days Left</th>
                                            </thead>
                                            <tbody class="tbody-list">
                                                ...
                                                <?php if (!empty($result)) {
                                                    ...
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td><?php echo !empty($value->difference)?$value->difference.'day(s)':''; ?></td>
                                                    </tr>
                                                <?php   } } ?>
                                            </tbody>
                                        </table>
