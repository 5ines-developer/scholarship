...
class M_dashboard extends CI_Model {
	...
	{
		return $this->db->where('id',$this->session->userdata('sgt_id'))->update('admin',$insert);
	}
    ...
    **/
    ...
    {
        $query = $this->db->select('psw')->where('id', $this->session->userdata('sgt_id'))->get('admin')->row_array();
    ...
    **/
    ...
    {
        $this->db->where('id', $this->session->userdata('sgt_id'))->update('admin', $datas);
