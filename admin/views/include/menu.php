    ...
    <ul class="men-ul">
        ...
        <ul class="collapsible men-lft">
            ...
            <li class="sc-m">
              ...
              <div class="collapsible-body"><span><a href="<?php echo base_url() ?>applications" class="<?php echo($this->uri->segment(1) == 'applications') ? 'active' :'' ?>">All Application</a></span></div>
              <div class="collapsible-body"><span><a href="<?php echo base_url() ?>applications" class="<?php echo($this->uri->segment(1) == 'applications/approved') ? 'active' :'' ?>">Approved Application</a></span></div>
              <div class="collapsible-body"><span><a href="<?php echo base_url() ?>applications" class="<?php echo($this->uri->segment(1) == 'applications/rejected') ? 'active' :'' ?>">Rejected Application</a></span></div>
