...
class M_reports extends CI_Model {
	...
	public function getScholar($district='',$taluk='',$year='',$school='',$company='',$caste='')
	{
		return $this->yearGet($district,$taluk,$year,$school,$company);
	}

	public function yearGet($district='',$taluk='',$year='',$school='',$company='',$caste='')
	{
		if (!empty($year)) {
            $date  = explode("-",$year);
            $sdate = $date[0];
	...
	public function scGet($district='',$taluk='',$year='',$school='',$company='',$caste='')
	{
	...
	public function stGet($district='',$taluk='',$year='',$school='',$company='',$caste='')
	{
		if (!empty($year)) { 		$this->db->where('a.application_year', $year); 	 } 
		if (!empty($district)) { 	$this->db->where('am.ins_district', $district); } 
		if (!empty($taluk)) { 		$this->db->where('am.ins_talluk', $taluk); 	 } 
	...
	public function obcGet($district='',$taluk='',$year='',$school='',$company='',$caste='')
	{
		if (!empty($year)) { 		$this->db->where('a.application_year', $year); 	 } 
		if (!empty($district)) { 	$this->db->where('am.ins_district', $district); } 
		if (!empty($taluk)) { 		$this->db->where('am.ins_talluk', $taluk); 	 } 
	...
	public function genGet($district='',$taluk='',$year='',$school='',$company='',$caste='')
	{
		if (!empty($year)) { 		$this->db->where('a.application_year', $year); 	 } 
		if (!empty($district)) { 	$this->db->where('am.ins_district', $district); } 
		if (!empty($taluk)) { 		$this->db->where('am.ins_talluk', $taluk); 	 } 
	...
	public function maleGet($district='',$taluk='',$year='',$school='',$company='',$caste='')
	{
		if (!empty($year)) { 		$this->db->where('a.application_year', $year); 	 } 
		if (!empty($district)) { 	$this->db->where('am.ins_district', $district); } 
		if (!empty($taluk)) { 		$this->db->where('am.ins_talluk', $taluk); 	 } 
	...
	public function femaleGet($district='',$taluk='',$year='',$school='',$company='',$caste='')
	{
		if (!empty($year)) { 		$this->db->where('a.application_year', $year); 	 } 
		if (!empty($district)) { 	$this->db->where('am.ins_district', $district); } 
		if (!empty($taluk)) { 		$this->db->where('am.ins_talluk', $taluk); 	 } 
	...
	public function approved($district='',$taluk='',$year='',$school='',$company='',$caste='')
	{
		if (!empty($year)) { 		$this->db->where('a.application_year', $year); 	 } 
		if (!empty($district)) { 	$this->db->where('am.ins_district', $district); } 
		if (!empty($taluk)) { 		$this->db->where('am.ins_talluk', $taluk); 	 } 
	...
	public function rejceted($district='',$taluk='',$year='',$school='',$company='',$caste='')
	{
		if (!empty($year)) { 		$this->db->where('a.application_year', $year); 	 } 
		if (!empty($district)) { 	$this->db->where('am.ins_district', $district); } 
		if (!empty($taluk)) { 		$this->db->where('am.ins_talluk', $taluk); 	 } 
	...
	public function pending($district='',$taluk='',$year='',$school='',$company='',$caste='')
	{
		if (!empty($year)) { 		$this->db->where('a.application_year', $year); 	 } 
		if (!empty($district)) { 	$this->db->where('am.ins_district', $district); } 
		if (!empty($taluk)) { 		$this->db->where('am.ins_talluk', $taluk); 	 } 
