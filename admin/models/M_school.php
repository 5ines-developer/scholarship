...
class M_school extends CI_Model {
	...
	public function getSchool($id='')
	{
		...
		return $this->db->select('schl.id,rs.reg_no,rs.school_address,rs.management_type,rs.school_category,rs.school_type,rs.urban_rural,tq.title,cty.title as district,sca.status,schl.reg_certification,schl.principal,schl.priciple_signature,schl.seal,schl.created_on')
		->from('school schl')
