...
class M_account extends CI_Model {
    ...
    {
        $this->db->select('s.id as schoolId, s.name, s.principal, s.email, s.phone, s.reg_no, s.reg_certification, s.priciple_signature, s.seal, a.address, c.title as district, a.pin, t.title as taluk,rs.school_address as school');
        $this->db->where('s.name', $this->session->userdata('school'));
        ...
        $this->db->join('reg_schools rs', 'rs.id = s.name', 'left');
