            ...
            <div class="container ">
                <div class="row m0">
                    ...
                    <div class="col s4 m4 push-m4">
                        <div class="center">
                            <a href="<?php echo $this->config->item('web_url') ?>"><img class="responsive-img" src="<?php echo $this->config->item('web_url') ?>assets/image/logo.png" alt="Karnataka Labour Welfare Board"></a>
                        </div>
                    </div>
