                    ...
                    <div class="col s12 m8  l8 reg-right">
                        <div class="form-block">
                            <div class="card-box">
                                ...
                                <form action="#" method="post" enctype="multipart/form-data" id="forgotForm">
                                    <div class="for-title">
                                ...
                                <div class="card-body row m0 pt15 pb15">
                                    <div class="input-field col s12">
                                        <select name="qstn">
                                          ...
                                          <option value="Name of your Favourite pet's">Name of your Favourite pet's?</option>
                                    ...
                                    <a href="" class="col mt15 mb15">Nevermind, I remember my password</a>
                                </div>
                            </form>
                            </div>
                        </div>
