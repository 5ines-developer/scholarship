                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="mcnTextContent"
                                                                                        ...
                                                                                        <br>
                                                                                        <span
                                                                                            style="font-size:22px">Dear Studennt,</span><br>
                                                                                        <br><?php echo $msg ?> <a href="<?php echo base_url() ?>student/login" target="_blank" >Click here</a> to login your account and check the Scholarship status.
