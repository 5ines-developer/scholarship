...
class M_dashboard extends CI_Model {
	...
	{
		return $this->db->where('id',$this->session->userdata('spmo_id'))->update('admin',$insert);
	}
    ...
    **/
    ...
    {
        $query = $this->db->select('psw')->where('id', $this->session->userdata('spmo_id'))->get('admin')->row_array();
    ...
    **/
    ...
    {
        $this->db->where('id', $this->session->userdata('spmo_id'))->update('admin', $datas);
