                                                            ...
                                                            <div class="col s12 l4 border-right">
                                                                <div class="profile-img">
                                                                    ...
                                                                    if((!empty($result[0]->reg_certification))){
                                                                        $img = $this->config->item('web_url').'institute/show-images/'.$result[0]->reg_certification;
                                                                    }else{
                                                        ...
                                                        <ul class="profile-ul">
                                                            ...
                                                            <?php 
                                                                    if((!empty($result[0]->priciple_signature))){
                                                                        $sign = $this->config->item('web_url').'institute/show-images/'.$result[0]->priciple_signature;
                                                            ...
                                                            <?php 
                                                                    if((!empty($result[0]->seal))){
                                                                        $seal = $this->config->item('web_url').'institute/show-images/'.$result[0]->seal;
