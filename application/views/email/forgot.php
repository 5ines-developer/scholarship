...
<a href="<?php echo base_url('student/forgot-verify?rid='.$regid) ?>">Reset Password &gt;</a>
<p style="font-size: 12px; line-height: 1.2; mso-line-height-alt: 19px; margin-top: 15px;"><span style="font-size: 13px;">If you didnot requested the password reset option, kindly ignore it.</span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<!--[if (!mso)&(!IE)]><!-->
