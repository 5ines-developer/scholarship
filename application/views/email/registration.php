...
<p style="font-size: 22px; line-height: 1.2; mso-line-height-alt: 26px; margin: 0;"><span style="font-size: 22px;">Thank you for registering with Karnataka Labour Welfare Board!</span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<p style="font-size: 14px; line-height: 1.5; mso-line-height-alt: 21px; margin: 0;">You have been succesfully registered with Karnataka Labour Welfare Board. please click the below link to activate your account .</p>
</div>
</div>
...
<a href="<?php echo base_url('student/verification?rid='.$regid) ?>">ACTIVATE MY ACCOUNT &gt;</a>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<!--[if (!mso)&(!IE)]><!-->
