...
<html lang="en">
  ...
  <body>
    <div class="container">
      ...
      <form action="<?php echo base_url()?>student/verify" method="post" enctype="multipart/form-data" id="otpform">
      ...
      $(document).ready(function() {
        $("#otpform").on('submit', function(event) {
            ...
            if (otp == '') {
              ...
              $.ajax({
                  url: "<?php echo base_url();?>student/verify",
                  type: "get",
                  dataType: "html",
                  ...
                  success: function(data) {
                    console.log(data);
                    if (data == otp) {
                      location.href = "<?php echo base_url('student/login')?>"
                    ...
                    if (data == '') {
                            location.href = "<?php echo base_url('student/register')?>";
                        }
