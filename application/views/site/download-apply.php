        ...
        <tbody>
          <tr>
           ...
           <tr style="border: 1px solid gray;">
              <td style="border:1px solid gray;" colspan="3"><img class="p-image" width="100px" src="<?php echo base_url() ?>/assets/img/logo.png" alt=""><br>
          ...
          <tr>
            ...
            <td style="border-top: 1px solid gray;border-bottom: 1px solid gray;border-left: none;border-right: 1px solid gray;" align="left">Present School Name : <?php echo $this->ci->m_stdapplication->schlName($result->school_id) ?></td>
          </tr>
          <tr>
            <td colspan="2" align="left" style="border:1px solid gray;" >Present School Address : <?php echo $this->ci->m_stdapplication->schlAddress($result->school_id) ?> </td>
