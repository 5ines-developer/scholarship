            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <div class="row">
                        ...
                        <div id="report" class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div id="contact" class="row">
                    ...
                    <div class="col-md-4 ">
                        ...
                        <ul class="footer-menu">
                            ...
                            <li><a class=" js-scroll-trigger" target="_blank" href="klwb.karnataka.gov.in">Karnataka Labour Welfare Board </a></li>
<!-- 
                            <li><a class=" js-scroll-trigger" href="#">Samudhaya Bhawan Online Booking

                                </a></li> -->
                                <li><a class=" js-scroll-trigger" target="_blank" href="https://labour.karnataka.gov.in/english">Labour Department
